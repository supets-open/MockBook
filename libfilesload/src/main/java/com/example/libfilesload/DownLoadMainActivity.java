...
public class DownLoadMainActivity extends FragmentActivity implements OnClickListener {
...
//                }
    ...
    BaseAdapter myAdapter = new BaseAdapter() {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            Holder holder = null;
            if (convertView == null) {
                convertView = LayoutInflater.from(DownLoadMainActivity.this).inflate(
        ...
        private void setClick(Holder holder) {
            holder.button_start.setOnClickListener(DownLoadMainActivity.this);
            holder.button_pause.setOnClickListener(DownLoadMainActivity.this);
            holder.button_resume.setOnClickListener(DownLoadMainActivity.this);
            holder.button_delete.setOnClickListener(DownLoadMainActivity.this);
        }
    ...
    public void onClick(View view) {
        ...
        } else if (i == R.id.button_pause) {
            downloadUtil.pause(url);
        } else if (i == R.id.button_resume) {
