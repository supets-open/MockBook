...
public class TestGeneratectivity extends AppCompatActivity {
    ...
    private void createChineseQRCode() {
        ...
        new AsyncTask<Void, Void, Bitmap>() {
            ...
            protected Bitmap doInBackground(Void... params) {
                return QRCodeEncoder.syncEncodeQRCode(mContent.getText().toString(), BGAQRCodeUtil.dp2px(TestGeneratectivity.this, 150));
            }
    ...
    private void createEnglishQRCode() {
        ...
        new AsyncTask<Void, Void, Bitmap>() {
            @Override
            protected Bitmap doInBackground(Void... params) {
                return QRCodeEncoder.syncEncodeQRCode(mContent.getText().toString(), BGAQRCodeUtil.dp2px(TestGeneratectivity.this, 150), Color.parseColor("#ff0000"));
            }
    ...
    private void createChineseQRCodeWithLogo() {
        ...
        new AsyncTask<Void, Void, Bitmap>() {
            @Override
            protected Bitmap doInBackground(Void... params) {
                Bitmap logoBitmap = BitmapFactory.decodeResource(TestGeneratectivity.this.getResources(), R.drawable.icon);
                return QRCodeEncoder.syncEncodeQRCode(mContent.getText().toString(), BGAQRCodeUtil.dp2px(TestGeneratectivity.this, 150), Color.parseColor("#ff0000"), logoBitmap);
            }
    ...
    private void createEnglishQRCodeWithLogo() {
        ...
        new AsyncTask<Void, Void, Bitmap>() {
            ...
            protected Bitmap doInBackground(Void... params) {
                Bitmap logoBitmap = BitmapFactory.decodeResource(TestGeneratectivity.this.getResources(), R.drawable.icon);
                return QRCodeEncoder.syncEncodeQRCode(mContent.getText().toString(), BGAQRCodeUtil.dp2px(TestGeneratectivity.this, 150), Color.BLACK, Color.WHITE, logoBitmap);
            }
